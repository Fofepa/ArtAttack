    ...
    public void create(PlayerBuilder builder, CharacterType charachterType, int ID){
        ...
        switch(playerType){
            case MUSICIAN ->{
                ...
                mb1.setName("Riff"); mb1.setActionPoints(7); mb1.setPower(4); mb1.setAreaAttack(true); mb1.setAttackArea(ab.getResult());  
                Move zappaMove1 = mb1.getResult();
                ab.addShape("base");
                mb1.setName("Guitar Strike"); mb1.setActionPoints(8); mb1.setPower(4); mb1.setAreaAttack(false); mb1.setAttackArea(ab.getResult());
                ...
                zappaMove3Area.addAll(ab.getResult());
                mb1.setName("Melody"); mb1.setActionPoints(8); mb1.setHealAmount(8); mb1.setAreaHeal(true); mb1.setHealArea(zappaMove3Area);
            ...
            case MOVIE_DIRECTOR ->{
                ...
                ab.addShape("base");
                lynchMove3Area.addAll(ab.getResult());
                mb1.setName("Flash"); mb1.setActionPoints(14); mb1.setPower(0); mb1.setAreaAttack(true); mb1.setAttackArea(lynchMove3Area);
