...
public class stallstrategyTest {
    ...
    public void setUp(){
        ...
        this.enemy = new Enemy(0, 'E', "Frank", new Coordinates(10,10),EnemyType.EMPLOYEE, 20, 20, 3,
                                 null,5,List.of(new Coordinates(-1, -1)),null,null,null,0);
        MapBuilder mapBuilder = new TestMapBuilder(); 
        mapBuilder.setPlayerOne(new Musician(1, '@', "Zappa", new Coordinates(15, 34), List.of(new Weapon("Hoe", "", 0)), 5, null, 20, 20, 0, 20, 1, 5, 2, null, null, null));
        mapBuilder.setPlayerTwo(new MovieDirector(0, '@', "Lynch", new Coordinates(25, 34), List.of(new Weapon("Hoe", "", 0)), 5, null, 20, 20, 0, 20, 1, 5, 2, null, null, null));
