...
public class fleestrategyTest {
    ...
    public void setUp(){
        ...
        mapBuilder.setPlayerOne(new Player(1, '@', "Zappa", new Coordinates(3, 78), List.of(new Weapon("Hoe", "", 1, PlayerType.MUSICIAN)), 5,5, null, 20, 20, 0, 20, 1, 5, 2, null, null, null, PlayerType.MUSICIAN));
        mapBuilder.setPlayerTwo(new Player(0, '@', "Lynch", new Coordinates(1, 1), List.of(new Weapon("Hoe", "", 1, PlayerType.MOVIE_DIRECTOR)), 5,5, null, 20, 20, 0, 20, 1, 5, 2, null, null, null, PlayerType.MOVIE_DIRECTOR));
